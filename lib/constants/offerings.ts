...
export const OFFERINGS: OfferingItem[] = [
  ...
  { slug: "pork-belly", label: "Pork Belly", category: "meats", styles: ["korean", "japanese"] },
  { slug: "short-rib", label: "Short Rib (Galbi)", category: "meats", styles: ["korean"] },
  { slug: "picanha", label: "Picanha", category: "meats", styles: ["brazilian"] },
  { slug: "asado", label: "Asado Cuts", category: "meats", styles: ["argentine"] },
  { slug: "lamb", label: "Lamb", category: "meats", styles: ["argentine", "other"] },
  { slug: "barbacoa", label: "Barbacoa", category: "meats", styles: ["other"] },
