...
const restaurants = [
  ...
  { name: "Burnt Ends", city: "Singapore", country: "Singapore", state: "SG", style: "other", lat: 1.2800, lng: 103.8500, address: "20 Teck Lim Rd, Singapore 088391", price: 4, rating: 4.8, featured: true, desc: "Michelin-starred modern BBQ with smoked quail, brisket, and open-kitchen theatre." },
